...
Make a function `subtract()` that subtracts the first input from the second.
```{r}
stopifnot(
  subtract(5, 3) == 2,
  subtract(2, 5) == -3,
...
In R, though, the best and easiest way to do this is with the `ifelse()` function,
because it automatically "vectorizes" the if-else statement (we'll discuss
vectorization in the next unit).  Here's an example:
