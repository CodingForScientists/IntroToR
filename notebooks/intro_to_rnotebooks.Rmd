...
**Exercises** Assign the requested variable names to the values listed. Confirm that it worked by by putting the variable on its own line at the end of the block.
